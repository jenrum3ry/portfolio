export const beingWrongFasterContent = `<h1>The PM's Real Job: Being Wrong Faster</h1>
...
<p><strong>Define "what would prove me wrong."</strong> For each assumption, explicitly state what evidence would make you rethink your approach. This creates clear decision points and prevents you from rationalizing away contradictory data.</p>

<p><strong>Build tight feedback loops.</strong> The faster you can test assumptions, the faster you can adjust. Instead of waiting for quarterly research studies, create continuous touchpoints with customers. Build prototypes. Run small experiments. Get signal flowing regularly.</p>

<p><strong>Separate learning investments from shipping commitments.</strong> When you commit to shipping something by a date, you're stuck. But if you commit to validating an assumption by a date, you preserve optionality. If you learn your assumption was wrong, you can pivot before investing in the full build.</p>

<p><strong>Practice changing your mind publicly.</strong> Share when you've discovered you were wrong. Explain what you learned and why you're adjusting course. This normalizes pivoting based on evidence and makes it easier for others on your team to do the same.</p>
